...
<head>
    ...
    <meta name="msapplication-TileImage" content="<?= base_url() ?>/admin/<?= base_url() ?> /admin/images/touch/ms-touch-icon-144x144-precomposed.png">
        ...
        <header class="mdl-layout__header">
            <div class="mdl-layout__header-row">
                ...
                <div class="avatar-dropdown" id="icon">
                    <span>Luke</span>
                    <img src="<?= base_url() ?>/admin/images/Icon_header.png">
                </div>
                <!-- Account dropdawn-->
